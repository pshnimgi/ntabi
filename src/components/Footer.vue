        ...
        >
          ...
          <v-col cols="4">
            <div>
              <blockquote class="text-body-2">
                ...
                email: kwonsix@ntabi.co.kr <br>
                부산광역시 동구 중앙대로 169 504호(태영 노블리안)<br />
          ...
          <v-col cols="4">
            ...
            <div class="text-body-1">
              copyright {{ new Date().getFullYear() }} Ntabi right reserved.
            </div>
          </v-col>
          <v-col
            cols="4"
          ...
          >
            <div>
              <blockquote>
                예금주 : (주)엔타비글로벌<br />
                우리은행 : 1006-901-267484<br />
                국민은행 : 947801-01-285353<br />
                부산은행 : 101-2062-7230-01<br />
              </blockquote>
            </div>
          </v-col>
        </v-row>
